    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        ...
        {showCloseButton && (
          ...
          >
            <XIcon strokeWidth={3} className="size-4" />
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-xl font-black tracking-wide text-foreground", className)}
      {...props}
    />
  )
}
